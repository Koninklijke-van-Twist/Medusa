...
/**
 * Bouwt de OData base URL voor een bedrijf binnen een environment.
 * Resultaat eindigt met een slash, klaar als prefix voor entity-namen.
 */
function auth_build_company_base_url(string $company, string $environment): string
{
    global $baseUrl;

    $environmentKey = trim($environment);
    if ($environmentKey === '') {
        // //ODataV4/... is geen vertaalbare OData-URL, ook niet via Mímir.
        throw new RuntimeException('Geen environment beschikbaar voor de OData-URL.');
    }
